...
/**
 * This class is used to connect to remote server and execute a command on that server. 
 * 
...
public class SSHClient {
	...
	public static String executeCommandOnRemoteHost(String hostname, String username, String newPassword, String command) {
		...
		try {
			...
			while (true) {
				...
				if (channel.isClosed()) {
					Utility.appendToLog("exit-status: " + channel.getExitStatus());
					break;
				}
				try {
					Thread.sleep(1000);
