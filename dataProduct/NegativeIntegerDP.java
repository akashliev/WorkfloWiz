...
public class NegativeIntegerDP extends DataProduct {
	public BigInteger data;

	public NegativeIntegerDP(String data, String dataName) {
		this.data = new BigInteger(data);
		this.dataName = dataName;
		this.description = data;
	}

	public NegativeIntegerDP(BigInteger data, String dataName) {
		this.data = data;
		this.dataName = dataName;
