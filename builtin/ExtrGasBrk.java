 ...
 * 
 */
public class ExtrGasBrk extends Workflow {
	public ExtrGasBrk(String instanceid) {
	...
	public void execute(String runID, boolean registerIntermediateDPs) {
		...
		try {
			...
			textAnalyzer.extractGasBrakeInfo(pathToInFile, pathToOutFile);
			...
			Utility.reportToLoggerNode("____ExtrGasBrk duration: " + new Long((endTime - startTime) / 1000).toString() + " s");
		} catch (Exception e) {
