 ...
 * 
 */
public class AnalyzeGasBrkL extends Workflow {
	public AnalyzeGasBrkL(String instanceid) {
	...
	public void execute(String runID, boolean registerIntermediateDPs) {
		...
		try {
			String result = textAnalyzer.getGasThenBrakeAbruptnessL(pathToInFile);
			...
			System.out.println(instanceId + " producing result: " + instanceId + ".o1." + runID + " value is: " + result);
//			CPUintensity.runCPUIntensiveTask();
			long endTime = System.currentTimeMillis();
			Utility.reportToLoggerNode("____AnalyzeGasBrk duration: " + new Long((endTime - startTime) / 1000).toString() + " s");
		} catch (Exception e) {
		}
