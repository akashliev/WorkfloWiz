 ...
 * 
 */
public class ExtrBrkngTurns extends Workflow {
	public ExtrBrkngTurns(String instanceid) {
	...
	public void execute(String runID, boolean registerIntermediateDPs) {
		...
		try {
			...
			textAnalyzer.extrBrakngOnTurns(pathToInFile, pathToOutFile);
			...
			System.out.println("ERROR: in workflow ExtrBrkngTurnsk, inst id: " + instanceId);
