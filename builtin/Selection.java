 ...
 * 
 */
public class Selection extends Workflow {
	public Selection(String instanceid) {
...
//		whereClause = whereClause + "\'";
		...
		try {
			...
			Utility.executeSelectIntoStatement(dbName, tableName, whereClause, resultTableName);
