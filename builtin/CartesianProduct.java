 ...
 * 
 */
public class CartesianProduct extends Workflow {
	public CartesianProduct(String instanceid) {
	...
	public void execute(String runID, boolean registerIntermediateDPs) {
		...
		try {
			...
			Utility.executeCartProduct(dbName, tableName1, tableName2, resultTableName);
