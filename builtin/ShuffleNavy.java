 ...
 * 
 */
public class ShuffleNavy extends Workflow {
	public ShuffleNavy(String instanceid) {
	...
	public void execute(String runID, boolean registerIntermediateDPs) throws Exception {
		...
		Utility.reportToLoggerNode("aaaaaaaaaaaaaaaaaaaaaaactually running workflow (execute method) " + instanceId + ", runID: " + runID);
		if (!readyToExecute())
			return;
		Utility.reportToLoggerNode("passed readyToExecute! " + instanceId + ", runID: " + runID);
