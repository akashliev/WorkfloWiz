 ...
 * 
 */
public class AnalyzeGasBrk extends Workflow {
	public AnalyzeGasBrk(String instanceid) {
	...
	public void execute(String runID, boolean registerIntermediateDPs) {
		...
		try {
			double result = textAnalyzer.getGasThenBrakeAbruptness(pathToInFile);
...
//			Utility.reportToLoggerNode(instanceId + " producing result: " + instanceId + ".o1." + runID + " value is: " + result);
		} catch (Exception e) {
		}
